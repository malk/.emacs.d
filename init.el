...
(custom-set-faces
 ...
 '(clojure-test-error-face ((t (:inherit font-lock-warning-face :underline t :weight bold))) t)
 '(clojure-test-failure-face ((t (:inherit font-lock-warning-face :background "tomato4" :underline t :weight bold))) t)
 '(clojure-test-success-face ((t (:inherit font-lock-comment-face :background "PaleGreen4" :underline t :weight bold))) t)
